        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="nbr_rep" id="nbr_rep" value="<?php echo $exercice['nbr_rep']; ?>" maxlength="50"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="idp" id="idp" value="<?php echo $exercice['idp']; ?>" maxlength="50"></td>
                </tr>
