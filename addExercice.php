...
if (
    ...
    if (
        ...
        $exerciceC->addExercice($exercice);
...
<body>
    <a href="ListExercice.php">Back to list </a>
    <hr>
    ...
    <form action="" method="POST">
        <table border="1" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="nomEx" id="nomEx" maxlength="50"></td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type="text" name="categorie" id="categorie" maxlength="50"></td>
            </tr>
...
<head>
  ...
  <title>HealthifyMe Bootstrap Template</title>
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Fitness</a></li>
...
<body>
    ...
    <form action="" method="POST">
        <table border="1" align="center">
            ...
            <tr>
                <td>
                    <label for="nbr_rep">nombre de repetition:
                    </label>
                </td>
                <td><input type="text" name="nbr_rep" id="nbr_rep"maxlength="50"></td>
            </tr>
            <tr>
                <td>
                    <label for="categorie">categorie:
            ...
            <tr>
                ...
                <td><input type="text" name="idp" id="idp" maxlength="50"></td>
            </tr>
